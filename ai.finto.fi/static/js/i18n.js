...
jQuery(function() {
    ...
    $.i18n().load({
        ...
        'en': {
            ...
            "copy-button-label-and-uri": "Copy label, URI and language code to clipboard",
        ...
        'sv': {
            ...
            "copy-button-label": "Kopiert term till urklipp",
            "copy-button-uri": "Kopiert URI till urklipp",
            "copy-button-label-and-uri": "Kopiert term, URI och språkets kod till urklipp",
        ...
        'fi': {
            ...
            "copy-button-label-and-uri": "Kopioi termi, URI ja kielikoodi leikepöydälle",
